      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex gap-4 mb-6">
              ...
              <a href="#" className="text-gray-100 hover:text-blue-400 transition-colors">
              <div className='w- 10 h-6'><TwitterIcon/></div>              </a>
              <a href="#" className="text-gray-100 hover:text-blue-400 transition-colors">
              <div className='w- 10 h-6'><LinkedInIcon/></div>               </a>
              <a href="#" className="text-gray-100 hover:text-blue-400 transition-colors">
              <div className='w- 10 h-6'><InstagramIcon/></div>               </a>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex">
              <input type="email" placeholder="Subscribe to newsletter" className="px-4 py-2 w-full bg-gray-800 rounded-l focus:outline-none focus:ring-2 focus:ring-blue-400" />
        ...
        <div className="mt-12">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="mb-4 md:mb-0">© {currentYear} Company Name. All rights reserved.</p>
